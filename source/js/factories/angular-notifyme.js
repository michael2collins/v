...
console.log('NotifyMe entered');
  ...
  (function(root, definition) {
      ...
      function NotifyMe(title, options) {
          console.log('NotifyMe constructor',title,options);
      ...
      NotifyMe.requestPermission = function() {
          console.log('NotifyMe requestPermission entered');
                  ...
                  if (window.Notification) {
                      Notification.requestPermission().then(function(permission) {
                          ...
                          if (permission === 'denied') {
                              reject('Permission issue.  Permission is:', permission);
                          } else {
                              NotifyMe.permissionGranted = true;
                              resolve();
                          }
                      });
                  } else {
      ...
      NotifyMe.prototype.launch = function() {
          console.log('NotifyMe launch entered');
