(function(window, angular, $) {
    ...
    var studentpick = {};
        ...
        $.fn.Data.Portlet('app-controller.js');
        ...
        function activate() {
            $log.debug('app-controller.js activate entered');
            ...
            return CalendarServices.getCalendarEvents(refreshpath).then(function(data) {
                    ...
                    if (typeof(data.events) !== "undefined") {
                      ...
                      /*      var atimetoadd = {
                        ...
                        */    
                            data.events[i].end = new Date(CalUtil.convertToMoment(data.events[i].end));
                            data.events[i].start = new Date(CalUtil.convertToMoment(data.events[i].start));
