...
<video controls preload="none" poster="images\specialoffer1.png"> 
   <source src="images\Promo.mp4" type="video/mp4"> 
</video> 
<!--
<div class="warning">Note: This video is up to 50MB in size. Playing it will cause this file in its entirety to be downloaded.</div>
-->
</div></div>
               <div class="clear"></div>
            <div class="grid_8">
...
<div class="description green_bg " style="height: 240px;">
                   <ul>
                     <li>
                        <span class="orange_font">2 Weeks of Classes and More!</span>
                     </li>
                     <li>
                        <p>Attend classes for 2 weeks</p>
                     </li>
                     <li>
                        <p>Receive a private lesson</p>
                     </li>
                     <li>
                        <p>Get a uniform</p>
                     </li>
                     <li>
                        <p>All for the low price of $19</p>
                     </li>
                   </ul>
                  <div class="inner-block">
