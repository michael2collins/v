...
rsync -avu -O --exclude=.git --exclude=natick --exclude=temp --exclude=node_modules --exclude=.c9  -e "ssh -p 44444 -i /home/ubuntu/.ssh/id_test" workspace/ michael2collins@someip.79.153.63:/home/michael2collins/Web/vtest/v
